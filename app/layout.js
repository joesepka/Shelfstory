...
// The Grove skin: Plus Jakarta (sans), Fraunces (serif headings), Spline Mono (figures).
...
export const metadata = { title: "ShelfStory · The Grove", description: "Account intel" };

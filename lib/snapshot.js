...
/* The date a window ENDED, for anywhere that needs to name one -- the account card's shelf list
   says when each item last landed. Same helper name and meaning as the desktop copy. */
export const windowEnd = (k = 0) => winEnd(k);
export const windowEndLabel = (k = 0) => md(winEnd(k));

"use client";
import { parents, HOUSE_PARENT } from "./profile";
...
// This client's labels, from the profile -- not two names the code recognises.
export const LABELS = parents.map(p => [p[0], p[1]]);
export function getLabel() {
  ...
  try {
    ...
    return v === null ? HOUSE_PARENT : v;
  } catch { return HOUSE_PARENT; }
}

...
// watch group = decelerating + at-risk ONLY — lapsed is its own bucket, never watch
export const isDeclining = h => isAtRisk(h);
...
// `n` rolling-month short labels ending at the DATA snapshot month, oldest first.
// Anchored to lib/snapshot.js, never to today: read in September against a July book,
// a today-anchored axis silently labels every bar one month late.
